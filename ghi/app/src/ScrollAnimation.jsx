    ...
    <div className="scroll container">
      <div className="row mb-5">
        <div className="col-12">
          <h2 className="scroll-h2" data-aos="fade-up">Get Started in 3 Easy Steps</h2>
        </div>
        ...
        <div className="col-12" data-aos="fade-up" data-aos-delay="400">
          <h3><i className="steps-icon fas fa-thumbtack"></i><span></span>Step 3: Start Pinning Ideas</h3>
      ...
      <div className="row text-center">
        <div className="col-12 mb-2">
            ...
            <button className="btn btn-outline-light btn-lg ml-3" data-aos="zoom-in" data-aos-delay="100"><i className="fas fa-search"></i> Explore Decor Ideas</button>
        </div>
      </div>
    </div>
  );
