...
from .views import api_rooms, api_room, api_projects, api_project, api_wishlist_items, api_wishlist_item, api_pins, api_pin, api_user_profiles, api_user_profile
...
urlpatterns = [
    ...
    path("wishlist/<int:id>/", api_wishlist_item, name="api_wishlist_item"),
